...
#    Updated: 2019/01/30 12:19:53 by vopolonc         ###   ########.fr        #
#                                                                              #
#******************************************************************************#

NAME = libft.a
fS = -Wall -Werror -Wextra 
SRCS = ft_fchrr.c ft_fchr.c ft_int_len.c ft_get_numb_len.c ft_skip.c ft_atoi.c ft_memalloc.c ft_putstr.c ft_strmapi.c ft_bzero.c \
...
ft_putnbr_fd.c ft_strmap.c ft_is_minus.c
OBJ := $(SRCS:%.c=%.o)
HEAD = includes/
